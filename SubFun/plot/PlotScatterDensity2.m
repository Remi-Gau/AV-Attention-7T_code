...
% view(2)
    ...
    set(gca,'tickdir', 'out', 'ticklength', [0.01 0.01], 'fontsize', 6, ...
        'xtick', linspace(1, Bins, 12) ,'xticklabel', linspace(XRange(1),XRange(2), 6),...
        'ytick', linspace(1, Bins, 12) ,'yticklabel', linspace(YRange(1),YRange(2), 6))
    
%     axis([0+Bins/4 Bins-Bins/4 0+Bins/4 Bins-Bins/4])
    axis([0 Bins 0 Bins])
