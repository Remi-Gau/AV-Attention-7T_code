function Analysis_MVPA_01_MVPA
clc; clear;
...
%                         Mask.ROI(end+1) = struct('name', 'TE', 'fname', 'rrwTE_MNI.nii');
                        Mask.ROI(1) = struct('name', 'STG', 'fname',  'rrwHG_STG_AAL.nii');
%                         
...
%                         Mask.ROI(end+1) = struct('name', 'V5', 'fname', 'rrwProbRet_V_hMT.nii');
                        ...
                        %                     Analysis to perform                   %
                        % --------------------------------------------------------- %
                        SVM(1) = struct('name', 'A Stim VS V Stim', 'class', [1 2], 'ROI',  1:length(Mask.ROI));
                        SVM(end+1) = struct('name', 'A Stim VS AV Stim', 'class', [1 3], 'ROI',  1:length(Mask.ROI));
                        SVM(end+1) = struct('name', 'V Stim VS AV Stim', 'class', [2 3], 'ROI',  1:length(Mask.ROI));
                        SVM(end+1) = struct('name', 'A Att VS V Att', 'class', [5 6], 'ROI',  1:length(Mask.ROI));
                        SVM(end+1) = struct('name', 'A Stim(A Att VS V Att)', 'class', [7 8], 'ROI',  1:length(Mask.ROI));
                        SVM(end+1) = struct('name', 'V Stim(A Att VS V Att)', 'class', [9 10], 'ROI',  1:length(Mask.ROI));
                        SVM(end+1) = struct('name', 'AV Stim(A Att VS V Att)', 'class', [11 12], 'ROI',  1:length(Mask.ROI));
                        ...
                        LayerLabelsFile = fullfile(AnalysisFolder, 'T1_06_Layers.nii');
