    ...
    for iROI = 2 % numel(ROI)
        ...
        for n=1:nMax
            ...
            FileName = fullfile(FigureFolder,'Baseline', 'RasterAllCdt', ...
                ['GrpLvl_RasterAllCdt_Baseline_V_stim_' ToPlot{iToPlot} '_' ROI(iROI).name '_CV.gif']);
...
for iToPlot = 2%:numel(ToPlot)
    ...
    for iROI = 1:4 % numel(ROI)
        ...
        for n=1:nMax
            ...
            FileName = fullfile(FigureFolder,'Baseline', 'RasterAllCdt', ...
                ['GrpLvl_RasterAllCdt_Baseline_A_stim_' ToPlot{iToPlot} '_' ROI(iROI).name '_CV.gif']);
...
for iToPlot = 1%:numel(ToPlot)
    ...
    FileName = fullfile(FigureFolder,'Baseline', 'RasterAllCdt', ...
        ['GrpLvl_RasterAllCdt_Baseline_' ToPlot{iToPlot} '_AllROIs_CV.gif']);
