...
for iSub = 1:size(SubjectList,1)
    ...
    for iCV = 1:2
        ...
        for iCdt = 1:6
            ...
            Y = U_A1(Test_rows,1); % take the correct condition of the first Eigenvariate of A1 (now a 1 X 12 vector)
            Y2 = nanmean(Cst_A1(Test_rows,:),2); % Average across vertices of activation (now a 1 X 12 vector)
            
            % Run GLM on all vertices
            for iVert = 1:size(Cst_V1,2)
                X = Cst_V1(Train_rows,iVert); % take the right condition S paramaters of V1
            ...
            B_act(iSub,iCdt,:,1,iCV) = nanmean(Vert_BOLD(:,1,Act_deact_V1==1),3);
            B_act(iSub,iCdt,:,2,iCV) = nanmean(Vert_BOLD(:,2,Act_deact_V1==1),3);
            V1_Act(iSub,iCV) = nanmean(nanmean(Cst_V1(Train_rows,Act_deact_V1==1))); %Keep the mean activation across blocks
            
            % On deactivated vertices same as above
            B_deact(iSub,iCdt,:,1,iCV) = nanmean(Vert_BOLD(:,1,Act_deact_V1==0),3);
            B_deact(iSub,iCdt,:,2,iCV) = nanmean(Vert_BOLD(:,2,Act_deact_V1==0),3);
            V1_Deact(iSub,iCV) = nanmean(nanmean(Cst_V1(Train_rows,Act_deact_V1==0)));
            ...
            for iSplit = 2:numel(IdxToAvg_V1)
                ...
                V1_Act_rank(iSub,iSplit,iCdt,iCV) = nanmean(nanmean(Cst_V1(Train_rows,Vert_2_select)));
            end
        ...
        for iCdt = 1:2
            ...
            % On activated vertices
            B_act_att(iSub,iCdt,:,1,iCV) = nanmean(Vert_BOLD(:,1,Act_deact_V1==1),3);
            B_act_att(iSub,iCdt,:,2,iCV) = nanmean(Vert_BOLD(:,2,Act_deact_V1==1),3);
            V1_Act_att(iSub,iCV) = nanmean(nanmean(Cst_V1(Train_rows,Act_deact_V1==1)));
            
            % On deactivated vertices same as above
            B_deact_att(iSub,iCdt,:,1,iCV) = nanmean(Vert_BOLD(:,1,Act_deact_V1==0),3);
            B_deact_att(iSub,iCdt,:,2,iCV) = nanmean(Vert_BOLD(:,2,Act_deact_V1==0),3);
            V1_Deact_att(iSub,iCV) = nanmean(nanmean(Cst_V1(Train_rows,Act_deact_V1==0)));
            ...
            for iSplit = 2:numel(IdxToAvg_V1)
                ...
                V1_Act_rank_att(iSub,iSplit,iCV) = nanmean(nanmean(Cst_V1(Train_rows,Vert_2_select)));
            end
        ...
        for iCdt = 1:2
            ...
            % On activated vertices
            B_act_sens(iSub,iCdt,:,1,iCV) = nanmean(Vert_BOLD(:,1,Act_deact_V1==1),3);
            B_act_sens(iSub,iCdt,:,2,iCV) = nanmean(Vert_BOLD(:,2,Act_deact_V1==1),3);
            V1_Act_sens(iSub,iCV) = nanmean(nanmean(Cst_V1(Train_rows,Act_deact_V1==1)));
            
            % On deactivated vertices same as above
            B_deact_sens(iSub,iCdt,:,1,iCV) = nanmean(Vert_BOLD(:,1,Act_deact_V1==0),3);
            B_deact_sens(iSub,iCdt,:,2,iCV) = nanmean(Vert_BOLD(:,2,Act_deact_V1==0),3);
            V1_Deact_sens(iSub,iCV) = nanmean(nanmean(Cst_V1(Train_rows,Act_deact_V1==0)));
            ...
            for iSplit = 2:numel(IdxToAvg_V1)
                ...
                V1_Act_rank_sens(iSub,iSplit,iCV) = nanmean(nanmean(Cst_V1(Train_rows,Vert_2_select)));
            end
