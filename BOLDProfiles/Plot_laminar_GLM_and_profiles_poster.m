...
print(gcf, fullfile(FigureFolder,['Fig2_deactivations_V123_' MedianSufix '.tif']), '-dtiff')
...
%     DATA.YLabel = 'Decoding accuracy';
    ...
    print(gcf, fullfile(FigureFolder,['Fig4_Attention_V123_Stim_' Stim{iStim} '_' MedianSufix '.tif']), '-dtiff')
...
print(gcf, fullfile(FigureFolder,['Fig3_CrossModalInfluence_V123_' MedianSufix '.tif']), '-dtiff')
