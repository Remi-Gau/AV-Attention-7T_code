...
%     Mask.ROI(1) = struct('name', 'TE1.0', 'fname', 'rrwTE_1.0_MNI.nii');
    ...
    Mask.ROI(end+1) = struct('name', 'Cortex', 'fname', 'Cortex.nii');
    ROI_VOL(:,:,:,end+1) = logical(LayersVol); %#ok<SAGROW>
    ...
    save(fullfile(SubjectFolder,'Structural','CBS','VoxPerLayer.mat'), 'VoxPerLayer')
